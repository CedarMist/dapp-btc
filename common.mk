...
SOLC_OPTS=--metadata --base-path $(COMMON_ROOT_DIR) --include-path $(COMMON_ROOT_DIR)interfaces --metadata-literal --bin --overwrite --optimize --via-ir # --optimize-runs 4294967295
