...
import {ITxVerifier,BtcTxProof} from "../../interfaces/ITxVerifier.sol";
...
// canonical chain.
contract TxVerifier is IERC165, IUsesBtcRelay, ITxVerifier {
    ...
    function supportsInterface(
        ...
        returns (bool)
    {
        return interfaceId == type(ITxVerifier).interfaceId
